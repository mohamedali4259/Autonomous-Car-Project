...
void TIMER1_initPhaseCorrectMod9()
{
	//select mode 9(PhaseCorrect)
...
void TIMER1_setOcr(u16 value)       /// TO Control SPeed of Motors
{
	OCR1A = value;
}


void TIMER1_setPCFrequency(u16 PC_pwm_frequency)      // Set Phase Correct PWM Frequency
{
	//f = 25 Hz
	ICR1 = (16000000/(2*PC_pwm_frequency*64));
	//top = 5000
